...
@AndroidEntryPoint
class EditPhoneDialogFragment : BottomSheetDialogFragment()
{
    //region variables
    lateinit var binding: FragmentPlaceEditPhoneBinding
    ...
    {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_place_edit_phone, container, false)
    ...
    companion object {
        fun newInstance(placeKey: String, data: String, canEdit: Boolean): EditPhoneDialogFragment {
            val args = Bundle()
            args.putString("placeKey", placeKey)
            args.putString("data", data)
            args.putBoolean("canEdit", canEdit)
            val fragment = EditPhoneDialogFragment()
    ...
    private fun initViews()
    {
        ...
        binding.toolbar.titleTv.text = getString(R.string.telephone)

        binding.phoneTextView.isVisible = !canEdit
        binding.phoneLayout.isVisible = canEdit
    ...
    private fun setOnClicked()
    {
        binding.updateButton.setOnClickListener {
            ...
            placeUpdateBody.phone = binding.phoneEditText.text.toString()
            viewModel.updatePlace(placeUpdateBody, placeKey)
        }
        binding.openButton.setOnClickListener {
            Constants.sendPhoneNumberToDialer(requireContext(), data)
        }
        binding.copyPhoneImageView.setOnClickListener {
