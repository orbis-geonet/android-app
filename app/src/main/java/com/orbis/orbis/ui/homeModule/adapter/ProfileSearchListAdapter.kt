...
class ProfileSearchListAdapter(private val interaction: ProfileSearchInteraction?, context:Context) :
    RecyclerView.Adapter<ProfileSearchListAdapter.ViewHolder>() {
    ...
    interface ProfileSearchInteraction {
        fun onItemClicked()
    }
}
