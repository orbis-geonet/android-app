package com.orbis.orbis.ui.storiesModule.utils


import com.orbis.orbis.ui.storiesModule.viewModel.Story
import com.orbis.orbis.ui.storiesModule.viewModel.StoryGroup
import kotlin.random.Random

object StoryGenerator {

    fun generateStories(): ArrayList<StoryGroup> {
        ...
        val userLocations = ArrayList<String>()
        ...
        userNames.add("Maria Luiza")
        userNames.add("Emma Stone")
        userNames.add("Sarah Jhonn")
        userNames.add("Amr SZ")
        userNames.add("Ghiath M")


        val userPostTexts = ArrayList<String>()
        userPostTexts.add("")
        userPostTexts.add("Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd")
        userPostTexts.add("Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed")
        userPostTexts.add("Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna")

        val storyUserList = ArrayList<StoryGroup>()
        for (i in 1..10) {
            ...
            for (j in 0 until storySize) {
                stories.add(
                    Story(
                        ...
                        userLocations[Random.nextInt(userLocations.size)],
                        userNames[Random.nextInt(userNames.size)],
                        userProfileUrls[Random.nextInt(userProfileUrls.size)],
                        userPostTexts[Random.nextInt(userPostTexts.size)]
                    )
                )
            }
            storyUserList.add(
