...
final class BitmapUtils {
    ...
    static final String logTag = "LassiBitmapUtils";
    /**
    ...
    private static BitmapSampled decodeSampledBitmapRegion(
        ...
        Log.d("CropDebug", "decodeSampledBitmapRegion - rect: " + rect);
        Log.d("CropDebug", "decodeSampledBitmapRegion - reqWidth: " + reqWidth + " reqHeight: " + reqHeight);
        InputStream stream = null;
        ...
        try {
            ...
            Log.d("CropDebug", "decodeSampledBitmapRegion - inSampleSize: " + options.inSampleSize);

            stream = context.getContentResolver().openInputStream(uri);
            decoder = BitmapRegionDecoder.newInstance(stream, false);

            Log.d("CropDebug", "decodeSampledBitmapRegion - decoder full image: " + decoder.getWidth() + " x " + decoder.getHeight());
            do {
                try {
